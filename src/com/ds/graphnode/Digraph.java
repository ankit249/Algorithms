...
// use BFS for GPS navigation
// use BFS for 
// example picture here:
// https://photos.google.com/photo/AF1QipNhDYdJMTcxJkvlTKCp5csHU-UayfQCvkyNeT7S
/**
 * 
 * http://www.cs.cornell.edu/courses/cs2110/2015fa/lecturenotes.html
 * 
 * An example class for directed graphs. The vertex type can be specified. There are no edge costs/weights.
 * 
...
public class Digraph<V> {
	...
	public List<V> topSort() {
		...
		Stack<V> stack = new Stack<V>(); // Stack as good as any here
        ...
        while (!stack.isEmpty()) {
			V v = stack.pop(); // Choose a vertex with zero in-degree
    ...
    public static void main (String[] args) {
        ...
        System.out.println("The current graph: " + graph);
		System.out.println("A topological sort of the vertices: "
				+ graph.topSort());
        System.out.println("The graph " + (graph.isDag()?"is":"is not") + " a dag");
        System.out.println("BFS distances starting from " + 2 + ": " + graph.bfsDistance(2));
