...
public class BinarySearchTree {
	...
	public static void main(String[] args) {
		...
		System.out.println("inorder successor of 25: " + bst.inorderSuccessor(root, new TreeNode(25)).data);
		System.out.println("inorder successor of 25: " + bst.inorderSuccessor(root, new TreeNode(40)).data);
	}
